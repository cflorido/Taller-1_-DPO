...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais al cual representa el atleta");
	...
	
	{
		...
		String imprimir = calculadora.anioatleta(nombre);
		
		System.out.println("El atleta pertenece al pais: "+ imprimir);
